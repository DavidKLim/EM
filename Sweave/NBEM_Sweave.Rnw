...
colnames(newtab) = c("$\\beta$","$\\phi$","true K","LFC","$n_{k}$","K","$p_{disc}$","ARI","Sensitivity","FPR","Pred Acc","iK","iARI")
tab1 = xtable(newtab,
              digits=2,
              table.placement="!h",
...
print(tab2,include.rownames=T, sanitize.text.function=identity,table.placement="H")
