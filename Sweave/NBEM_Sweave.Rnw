...
tab2 = xtable(table1_EM_35,
              digits=2,
              table.placement="!h",
              caption="Effects of high/low simulated log means ($\\beta = 3.75$ and $6.50$) with high and very high noise ($\\phi = 0.35$) in simulated datasets on performance.",
...
tab3 = xtable(table1_EM_50,
              digits=2,
              table.placement="!h",
              caption="Effects of high/low simulated log means ($\\beta = 3.75$ and $6.50$) with high and very high noise ($\\phi = 0.50$) in simulated datasets on performance.",
...
tab4 = xtable(table1_EM_100,
              digits=2,
              table.placement="!h",
              caption="Effects of high/low simulated log means ($\\beta = 3.75$ and $6.50$) with high and very high noise ($\\phi = 1.00$) in simulated datasets on performance.",
...
tab5 = xtable(table2_other_order_15,
              digits=2,
              table.placement="!h",
              caption="Effects of high/low simulated log means ($\\beta = 3.75$ and $6.50$) with low and medium noise ($\\phi = 0.15$) in simulated datasets on performance, compared to competing methods iCluster+, average-linkage hierarchical clustering (HC) and K-medoids (KM). Fixed $p_{disc}$ = 0.05",
...
tab6 = xtable(table2_other_order_35,
              digits=2,
              table.placement="!h",
              caption="Effects of high/low simulated log means ($\\beta = 3.75$ and $6.50$) with high and very high noise ($\\phi = 0.35$) in simulated datasets on performance, compared to competing methods HC and KM.",
...
tab7 = xtable(table2_other_order_50,
              digits=2,
              table.placement="!h",
              caption="Effects of high/low simulated log means ($\\beta = 3.75$ and $6.50$) with high and very high noise ($\\phi = 0.50$) in simulated datasets on performance, compared to competing methods HC and KM.",
...
tab8 = xtable(table2_other_order_100,
              digits=2,
              table.placement="!h",
              caption="Effects of high/low simulated log means ($\\beta = 3.75$ and $6.50$) with high and very high noise ($\\phi = 1.00$) in simulated datasets on performance, compared to competing methods HC and KM.",
...
tab5 = xtable(table2_other_OA_15,
              digits=2,
              table.placement="!h",
              caption="Effects of high/low simulated log means ($\\beta = 3.75$ and $6.50$) with low and medium noise ($\\phi = 0.15$) in simulated datasets on performance, compared to competing methods iCluster+, average-linkage hierarchical clustering (HC) and K-medoids (KM).",
              label = "tab:5",na.print="")      # K=3, n=50, g=1000
...
\end{center}
\caption{"Boxplots of ARI of competing methodsacross simulations at low ($\phi=0.15$, top-left), moderate ($\phi=0.35$, top-right), high ($\phi=0.50$, bottom-left), and very high ($\phi=1.00$, bottom-right) noise.}
\label{fig:bplots}
\end{figure}
...
\end{center}
\caption{"Boxplots of ARI at fixed case of $K=6$, $\beta=6.5$, $LFC=1$, $n=100$, and $p_{disc}=0.05$ of competing methods at low ($\phi=0.15$, top-left), moderate ($\phi=0.35$, top-right), high ($\phi=0.50$, bottom-left), and very high ($\phi=1.00$, bottom-right) noise.}
\label{fig:bplots2}
\end{figure}
...
tab9 = xtable(table2,
              ...
              label = "tab:9",na.print="",floating.environment = "table*")      # K=3, n=50, g=1000jo
